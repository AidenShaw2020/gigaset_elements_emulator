...
--   dmoff / dmon - senzor je / neni na svem miste (demontaz)
--
...
-- retezec neni, rozumi mu az firmware uzlu.  Overeno 2026-08-14 na zivem HW,
-- ze uzel ignoruje cal, cal1, cal=1, set=cal,1, calibrate i startcal.  Knihovna
-- proto po rucnim podnetu prochazi dalsi kandidaty, jeden na kazdou zadost.
-- Prvni z nich je `verreq`: na ten uzel odpovedet MUSI, takze rovnou ukaze,
-- jestli vubec nejaky prikaz prijima, nebo je chyba jinde nez v nazvu.
--
-- Cloud API zna mezistav "cal1started", takze prikaz krok nejspis spousti -
-- proto rodina calXstart pred ostatnimi tvary.
